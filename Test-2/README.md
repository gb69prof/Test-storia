# Test alternativo randomizzato - Seconda guerra mondiale
...
- `questions.js`: banca dati delle 20 domande nuove.
- `manifest.webmanifest` e `sw.js`: supporto PWA/offline basilare.

## Funzioni

- 20 domande nuove sulla Seconda guerra mondiale.
- 4 risposte per ogni domanda, una sola corretta.
- Alternative bilanciate nella lunghezza, per non rendere riconoscibile la risposta giusta.
